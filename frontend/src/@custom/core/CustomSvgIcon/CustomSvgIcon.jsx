...
/**
 * The Root styled component is used to style the root div of the CustomSvgIcon component.
...
/**
 * The CustomSvgIcon component is responsible for rendering an SVG icon with a specified size and color.
 * It uses various MUI components to render the icon.
 * The component is memoized to prevent unnecessary re-renders.
 */
const CustomSvgIcon = forwardRef((props, ref) => {
