import { useDebounce, usePrevious } from '@custom/hooks';
...
/**
 * The Root styled component is used to style the root div of the CustomSettings component.
 * It uses the styled function from the MUI styles library to create a styled component.
 */
const Root = styled('div')(({ theme }) => ({
	'& .CustomSettings-formControl': {
		margin: '6px 0',
		width: '100%',
		'&:last-child': {
			marginBottom: 0
	...
	'& .CustomSettings-group': {},
	'& .CustomSettings-formGroupTitle': {
		position: 'absolute',
		top: -10,
		left: 8,
		fontWeight: 600,
...
/**
 * The CustomSettings component is responsible for rendering the settings form for the Custom React application.
...
function CustomSettings() {
				...
				switch (formControl.type) {
						...
						return (
							<Controller
								...
								render={({ field }) => (
									<FormControl
										component="fieldset"
										className="CustomSettings-formControl"
									>
										<FormLabel
											component="legend"
											className="text-14"
										...
										<RadioGroup
											...
											className="CustomSettings-group"
					...
					case 'group': {
						return (
							<div
								key={target}
								className="CustomSettings-formGroup"
							>
								<Typography
									className="CustomSettings-formGroupTitle"
	...
	return (
		<Root>
			<div className="CustomSettings-formGroup">
				<Typography
					className="CustomSettings-formGroupTitle"
					color="text.secondary"
				>
			...
			<div className="CustomSettings-formGroup pb-16">
				<Typography
					className="CustomSettings-formGroupTitle"
					color="text.secondary"
				>
...
export default memo(CustomSettings);
