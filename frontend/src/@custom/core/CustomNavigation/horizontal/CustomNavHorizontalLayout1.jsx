...
/**
 * CustomNavHorizontalLayout1 is a react component used for building and
 * rendering horizontal navigation menus, using the Material UI List component.
 */
function CustomNavHorizontalLayout1(props) {
...
export default CustomNavHorizontalLayout1;
