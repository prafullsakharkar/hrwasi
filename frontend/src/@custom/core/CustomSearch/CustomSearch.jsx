...
const Root = styled('div')(({ theme }) => ({
	...
	'& .CustomSearch-suggestionsContainerOpen': {
		position: 'absolute',
		zIndex: 1,
	...
	'& .CustomSearch-suggestion': {
		display: 'block'
	},
	'& .CustomSearch-suggestionsList': {
		margin: 0,
		padding: 0,
		listStyleType: 'none'
	},
			...
			{variant === 'basic' ? (
				...
				<>
					<TextField
						...
						InputProps={{
							...
							classes: {
								input: 'CustomSearch-input py-0 px-16 h-40 md:h-48 ltr:pr-48 rtl:pl-48',
				...
				<TextField
					...
					InputProps={{
						...
						classes: {
							input: 'CustomSearch-input py-0 px-16 h-48 md:h-64'
						}
					}}
					variant="standard"
					{...other}
	...
	return (
		...
		>
			<ListItemIcon className="min-w-40">
				{suggestion.icon ? (
					<CustomSvgIcon>{suggestion.icon}</CustomSvgIcon>
				) : (
	...
	const {
		...
		trigger = (
			<IconButton
				...
				size="large"
			>
				<CustomSvgIcon>heroicons-outline:search</CustomSvgIcon>
			</IconButton>
		)
	} = props;
				...
				>
					<Autosuggest
						...
						theme={{
							...
							suggestionsList: 'CustomSearch-suggestionsList',
							suggestion: 'CustomSearch-suggestion'
						}}
