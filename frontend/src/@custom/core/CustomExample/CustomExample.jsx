...
/**
 * CustomExample component gives a visual display as well as code for a component example.
				...
				>
					{Component && (
						<Tab
							...
							icon={<CustomSvgIcon>heroicons-outline:eye</CustomSvgIcon>}
						/>
					)}
					{raw && (
						<Tab
							classes={{ root: 'min-w-64' }}
							icon={<CustomSvgIcon>heroicons-outline:code</CustomSvgIcon>}
						/>
					)}
				</Tabs>
			</Box>
