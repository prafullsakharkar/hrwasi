import { customDark } from '@custom/colors';
...
/**
 * The defaultSettings object defines the default settings for the Custom application.
 */
...
/**
 * The getParsedQuerySettings function parses the query string to retrieve the default settings for the Custom application.
 * It returns a CustomSettingsConfigType object that can be used to configure the application.
 */
