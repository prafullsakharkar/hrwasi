import BrowserRouter from '@custom/core/BrowserRouter';
import CustomAuthorization from '@custom/core/CustomAuthorization/CustomAuthorization';
import { useCallback, useEffect, useMemo, useState } from 'react';
import { useAppDispatch, useAppSelector } from 'app/store/hooks';
import CustomSplashScreen from '@custom/core/CustomSplashScreen/CustomSplashScreen';
	...
	return useMemo(
		() =>
			isLoading ? (
				...
				<BrowserRouter>
					<CustomAuthorization userRole={userRole}>{children}</CustomAuthorization>
				</BrowserRouter>
			),
