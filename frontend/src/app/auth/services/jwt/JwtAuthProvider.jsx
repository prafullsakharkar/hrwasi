...
function JwtAuthProvider(props) {
	...
	const signOut = useCallback(() => {
		...
		setIsAuthenticated(false);
		setUser(null);
		return axios.post(config.signOutUrl)
	}, []);
	/**
	 * Forgot Password
	 */
	const forgotPassword = (data) => {
		...
		setIsAuthenticated(false);
		setUser(null);
		return axios.post(config.forgotPasswordUrl, data)
	};
	const resetPassword = (data) => {
		resetSession();
		setIsAuthenticated(false);
		setUser(null);
		return axios.post(config.resetPasswordUrl, data)
	};
	/**
	 * Update user
	 */
	...
	const authContextValue = useMemo(
		...
		[user, isAuthenticated, isLoading, signIn, signUp, signOut, updateUser, refreshToken, setIsLoading, forgotPassword, resetPassword]
	);
